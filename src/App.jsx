...
// ── Data ──────────────────────────────────────────────────────────────────────
const FIXTURES = [
  { id:"m1",  num:1,  group:"A", home:"Mexico",        away:"South Africa",  date:"2026-06-11", time:"14:00" },
  { id:"m2",  num:2,  group:"A", home:"Korea Republic",away:"Czechia",       date:"2026-06-11", time:"21:00" },
  { id:"m3",  num:3,  group:"B", home:"Canada",        away:"Bosnia & Herz.",date:"2026-06-12", time:"14:00" },
  { id:"m4",  num:4,  group:"D", home:"USA",           away:"Paraguay",      date:"2026-06-12", time:"20:00" },
  { id:"m5",  num:5,  group:"C", home:"Haiti",         away:"Scotland",      date:"2026-06-13", time:"20:00" },
  { id:"m6",  num:6,  group:"D", home:"Australia",     away:"Türkiye",       date:"2026-06-13", time:"23:00" },
  { id:"m7",  num:7,  group:"C", home:"Brazil",        away:"Morocco",       date:"2026-06-13", time:"17:00" },
  { id:"m8",  num:8,  group:"B", home:"Qatar",         away:"Switzerland",   date:"2026-06-13", time:"14:00" },
  { id:"m9",  num:9,  group:"E", home:"Côte d'Ivoire", away:"Ecuador",       date:"2026-06-14", time:"18:00" },
  { id:"m10", num:10, group:"E", home:"Germany",       away:"Curaçao",       date:"2026-06-14", time:"12:00" },
  { id:"m11", num:11, group:"F", home:"Netherlands",   away:"Japan",         date:"2026-06-14", time:"15:00" },
  { id:"m12", num:12, group:"F", home:"Sweden",        away:"Tunisia",       date:"2026-06-14", time:"21:00" },
  { id:"m13", num:13, group:"H", home:"Saudi Arabia",  away:"Uruguay",       date:"2026-06-15", time:"17:00" },
  { id:"m14", num:14, group:"H", home:"Spain",         away:"Cabo Verde",    date:"2026-06-15", time:"11:00" },
  { id:"m15", num:15, group:"G", home:"IR Iran",       away:"New Zealand",   date:"2026-06-15", time:"20:00" },
  { id:"m16", num:16, group:"G", home:"Belgium",       away:"Egypt",         date:"2026-06-15", time:"14:00" },
  { id:"m17", num:17, group:"I", home:"France",        away:"Senegal",       date:"2026-06-16", time:"14:00" },
  { id:"m18", num:18, group:"I", home:"Iraq",          away:"Norway",        date:"2026-06-16", time:"17:00" },
  { id:"m19", num:19, group:"J", home:"Argentina",     away:"Algeria",       date:"2026-06-16", time:"20:00" },
  { id:"m20", num:20, group:"J", home:"Austria",       away:"Jordan",        date:"2026-06-16", time:"23:00" },
  { id:"m21", num:21, group:"L", home:"England",       away:"Croatia",       date:"2026-06-17", time:"15:00" },
  { id:"m22", num:22, group:"K", home:"Uzbekistan",    away:"Colombia",      date:"2026-06-17", time:"21:00" },
  { id:"m23", num:23, group:"K", home:"Portugal",      away:"Congo DR",      date:"2026-06-17", time:"12:00" },
  { id:"m24", num:24, group:"B", home:"Canada",        away:"Qatar",         date:"2026-06-18", time:"17:00" },
  { id:"m25", num:25, group:"A", home:"Czechia",       away:"South Africa",  date:"2026-06-18", time:"11:00" },
  { id:"m26", num:26, group:"B", home:"Switzerland",   away:"Bosnia & Herz.",date:"2026-06-18", time:"14:00" },
  { id:"m27", num:27, group:"A", home:"Mexico",        away:"Korea Republic",date:"2026-06-18", time:"20:00" },
  { id:"m28", num:28, group:"C", home:"Brazil",        away:"Haiti",         date:"2026-06-19", time:"19:30" },
  { id:"m29", num:29, group:"C", home:"Scotland",      away:"Morocco",       date:"2026-06-19", time:"17:00" },
  { id:"m30", num:30, group:"D", home:"USA",           away:"Australia",     date:"2026-06-19", time:"14:00" },
  { id:"m31", num:31, group:"D", home:"Türkiye",       away:"Paraguay",      date:"2026-06-19", time:"22:00" },
  { id:"m32", num:32, group:"F", home:"Sweden",        away:"Tunisia",       date:"2026-06-20", time:"23:00" },
  { id:"m33", num:33, group:"E", home:"Germany",       away:"Côte d'Ivoire", date:"2026-06-20", time:"15:00" },
  { id:"m34", num:34, group:"E", home:"Ecuador",       away:"Curaçao",       date:"2026-06-20", time:"19:00" },
  { id:"m35", num:35, group:"F", home:"Netherlands",   away:"Sweden",        date:"2026-06-20", time:"12:00" },
  { id:"m36", num:36, group:"F", home:"Tunisia",       away:"Japan",         date:"2026-06-20", time:"23:00" },
  { id:"m37", num:37, group:"H", home:"Uruguay",       away:"Cabo Verde",    date:"2026-06-21", time:"17:00" },
  { id:"m38", num:38, group:"H", home:"Spain",         away:"Saudi Arabia",  date:"2026-06-21", time:"11:00" },
  { id:"m39", num:39, group:"G", home:"Belgium",       away:"IR Iran",       date:"2026-06-21", time:"14:00" },
  { id:"m40", num:40, group:"J", home:"Jordan",        away:"Algeria",       date:"2026-06-22", time:"22:00" },
  { id:"m41", num:41, group:"I", home:"Norway",        away:"Senegal",       date:"2026-06-22", time:"19:00" },
  { id:"m42", num:42, group:"I", home:"France",        away:"Iraq",          date:"2026-06-22", time:"16:00" },
  { id:"m43", num:43, group:"J", home:"Argentina",     away:"Austria",       date:"2026-06-22", time:"12:00" },
  { id:"m44", num:44, group:"B", home:"Switzerland",   away:"Canada",        date:"2026-06-24", time:"14:00" },
  { id:"m45", num:45, group:"L", home:"England",       away:"Ghana",         date:"2026-06-23", time:"15:00" },
  { id:"m46", num:46, group:"L", home:"Panama",        away:"Croatia",       date:"2026-06-23", time:"18:00" },
  { id:"m47", num:47, group:"C", home:"Morocco",       away:"Haiti",         date:"2026-06-24", time:"17:00" },
  { id:"m48", num:48, group:"K", home:"Colombia",      away:"Congo DR",      date:"2026-06-23", time:"21:00" },
  { id:"m49", num:49, group:"C", home:"Scotland",      away:"Brazil",        date:"2026-06-24", time:"17:00" },
  { id:"m50", num:50, group:"C", home:"Morocco",       away:"Haiti",         date:"2026-06-24", time:"17:00" },
  { id:"m51", num:51, group:"A", home:"South Africa",  away:"Korea Republic",date:"2026-06-24", time:"20:00" },
  { id:"m52", num:52, group:"B", home:"Bosnia & Herz.",away:"Qatar",         date:"2026-06-24", time:"14:00" },
  { id:"m53", num:53, group:"A", home:"Czechia",       away:"Mexico",        date:"2026-06-24", time:"20:00" },
  { id:"m54", num:54, group:"K", home:"Portugal",      away:"Uzbekistan",    date:"2026-06-23", time:"12:00" },
  { id:"m55", num:55, group:"E", home:"Curaçao",       away:"Côte d'Ivoire", date:"2026-06-25", time:"15:00" },
  { id:"m56", num:56, group:"E", home:"Ecuador",       away:"Germany",       date:"2026-06-25", time:"15:00" },
  { id:"m57", num:57, group:"F", home:"Japan",         away:"Sweden",        date:"2026-06-25", time:"18:00" },
  { id:"m58", num:58, group:"F", home:"Tunisia",       away:"Netherlands",   date:"2026-06-25", time:"18:00" },
  { id:"m59", num:59, group:"D", home:"Türkiye",       away:"USA",           date:"2026-06-25", time:"21:00" },
  { id:"m60", num:60, group:"D", home:"Paraguay",      away:"Australia",     date:"2026-06-25", time:"21:00" },
  { id:"m61", num:61, group:"I", home:"Norway",        away:"France",        date:"2026-06-26", time:"14:00" },
  { id:"m62", num:62, group:"I", home:"Senegal",       away:"Iraq",          date:"2026-06-26", time:"14:00" },
  { id:"m63", num:63, group:"G", home:"Egypt",         away:"IR Iran",       date:"2026-06-26", time:"22:00" },
  { id:"m64", num:64, group:"G", home:"New Zealand",   away:"Belgium",       date:"2026-06-26", time:"22:00" },
  { id:"m65", num:65, group:"H", home:"Uruguay",       away:"Spain",         date:"2026-06-26", time:"19:00" },
  { id:"m66", num:66, group:"H", home:"Cabo Verde",    away:"Saudi Arabia",  date:"2026-06-26", time:"19:00" },
  { id:"m67", num:67, group:"L", home:"Croatia",       away:"Ghana",         date:"2026-06-27", time:"16:00" },
  { id:"m68", num:68, group:"L", home:"Panama",        away:"England",       date:"2026-06-27", time:"16:00" },
  { id:"m69", num:69, group:"J", home:"Jordan",        away:"Argentina",     date:"2026-06-27", time:"18:30" },
  { id:"m70", num:70, group:"J", home:"Algeria",       away:"Austria",       date:"2026-06-27", time:"18:30" },
  { id:"m71", num:71, group:"K", home:"Colombia",      away:"Portugal",      date:"2026-06-27", time:"18:30" },
  { id:"m72", num:72, group:"K", home:"Congo DR",      away:"Uzbekistan",    date:"2026-06-27", time:"18:30" },
]
...
function toET(date, time) {
  ...
  return new Date(`${date}T${String(h).padStart(2,"0")}:${String(m).padStart(2,"0")}:00-05:00`)
}
function isLocked(f) { return Date.now() >= toET(f.date, f.time).getTime() }
function todayET() {
  const et = new Date(new Date().toLocaleString("en-US",{timeZone:"America/Winnipeg"}))
